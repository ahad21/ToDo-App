            ...
            Expanded(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(flex: 20, child: Padding(padding: EdgeInsets.only(left: 5),child: ElevatedButton(onPressed: (){AddItem();},child: Text('Add',style: TextStyle(color: Colors.white),),style: AppButtonStyle(),),)),
                  ],
                )
            ),
            Expanded(
